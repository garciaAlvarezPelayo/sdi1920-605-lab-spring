...
public class NotaneitorTests {
	...
	public void PR06() {
		...
		// Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "990B", "Jose", "Perez", "77777", "77777");
		// COmprobamos el error de DNI con longitud menor a 5.
		...
		// Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "99999990B", "Jose", "Cal", "77777", "77777");
		// COmprobamos el error de apellido con longitud menor a 5.
		PO_RegisterView.checkKey(driver, "Error.signup.lastName.length", PO_Properties.getSPANISH());
		// Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "99999990B", "Jose", "Perez", "7", "7");
		// COmprobamos el error de contraseña con longitud menor a 5.
		PO_RegisterView.checkKey(driver, "Error.signup.password.length", PO_Properties.getSPANISH());
		// Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "99999990B", "Jose", "Perez", "77777", "88888");
		// COmprobamos el error de contraseña que coincide con confirmar contraseña.
	...
	// PRN. Identificación válida con usuario de ROL Administrador (
	// 99999988F/123456)
	@Test
	public void PR09() {
		// Vamos al formulario de logueo.
	...
	// PRN. Identificación inválida con usuario de ROL alumno ( 99999990A/123456)
	@Test
	public void PR10() {
		// Vamos al formulario de logueo.
		PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
	...
	public void PR14() {
		...
		PO_PrivateView.clickElement(driver, "free", "//li[contains(@id,'marks-menu')]/a", 0);
		PO_PrivateView.clickElement(driver, "free", "//a[contains(@href, 'mark/add')]", 0);
		// Ahora vamos a rellenar la nota. //option[contains(@value, '4')]
		PO_PrivateView.fillFormAddMark(driver, 3, "Nota Nueva 1", "8");
		// Esperamos a que se muestren los enlaces de paginación la lista de notas
		PO_PrivateView.clickElement(driver, "free", "//a[contains(@class, 'page-link')]", 3);
	...
	@Test public void PR15() { 
		...
		PO_PrivateView.clickElement(driver, "free", "//a[contains(@href, 'mark/list')]", 0);

		PO_PrivateView.clickElement(driver, "free", "//a[contains(@class, 'page-link')]", 3);

		PO_PrivateView.clickElement(driver, "free", "//td[contains(text(), 'Nota Nueva 1')]/following-sibling::*/a[contains(@href, 'mark/delete')]", 0);
